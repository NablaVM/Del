...
#include "codeblocks/Alloc.hpp"
#include "codeblocks/BlockAggregator.hpp"
#include "codeblocks/LoadStore.hpp"
#include "codeblocks/Operations.hpp"
#include "codeblocks/Primitives.hpp"
#include "codeblocks/ConditionalContext.hpp"
#include "codeblocks/ForLoopContext.hpp"
#include "codeblocks/WhileLoopContext.hpp"
...
namespace FORGE
{
        ...
        */
        ...
        for(auto & ins : command.instructions)
        {
            switch(ins->instruction)
            {
                ...
                case CODEGEN::TYPES::InstructionSet::STORE: current_aggregator->add_block(new CODE::Store(command.memory_info.start_pos, SETTINGS::SYSTEM_WORD_SIZE_BYTES, command.id)); break;
                ...
                default:
                    std::cerr << "Codegen :: Developer error : Default accessed in command!" << std::endl;
                    break;
            }
    ...
    void Codegen::set_symbol_table(SymbolTable * symbol_table)
    {
    ...
    SymbolTable * Codegen::getSymbolTable() const
    {
        return symbol_table;
    }
}