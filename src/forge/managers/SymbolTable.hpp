...
namespace FORGE
{
    ...
    public:
        ...
        bool is_existing_symbol_of_type(std::string symbol, DataType type);

        //! \brief Add a symbol to the current context
        //! \param symbol The symbol to add
        //! \param type The value type to add as
        //! \param is_immutable Flag to indicate if the symbol can be changed ot not
        void add_symbol(std::string symbol, DataType type, bool is_immutable);
        ...
        //! \param symbol The symbol to check for
        //! \returns Type of the given symbol, DataType::UNDEFINED if it doesn't exist
        DataType get_value_type(std::string symbol);
    ...
    private:
        ...
        {
        public:
            Context(std::string name) : context_name(name), return_type(DataType::UNDEFINED) {}
            std::string context_name;
            std::map< std::string, SymbolInfo > symbol_map; 
            std::vector<Variable> context_parameters;
